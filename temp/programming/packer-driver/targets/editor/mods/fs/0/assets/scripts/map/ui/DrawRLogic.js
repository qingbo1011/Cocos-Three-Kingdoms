      ...
      _export("default", DrawRLogic = (_dec = ccclass('DrawRLogic'), _dec2 = property(Prefab), _dec3 = property(Layout), _dec4 = property(Layout), _dec(_class = (_class2 = (_temp = class DrawRLogic extends Component {
        ...
        setData(data) {
          ...
          if (data.length == 1) {
            ...
            let com = children[0].getComponent(_crd && GeneralItemLogic === void 0 ? (_reportPossibleCrUseOfGeneralItemLogic({
              error: Error()
            ...
            for (var i = 0; i < this._maxSize; i++) {
              ...
              if (data[i]) {
                child.active = true;
                let com = child.getComponent(_crd && GeneralItemLogic === void 0 ? (_reportPossibleCrUseOfGeneralItemLogic({
                  error: Error()
                }), GeneralItemLogic) : GeneralItemLogic);

                if (com) {
                  com.setData(data[i], (_crd && GeneralItemType === void 0 ? (_reportPossibleCrUseOfGeneralItemType({
                    error: Error()
                  }), GeneralItemType) : GeneralItemType).GeneralNoThing);
                }
              } else {
