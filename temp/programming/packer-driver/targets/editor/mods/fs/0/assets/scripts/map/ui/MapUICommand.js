    ...
    execute: function () {
      ...
      _export("default", MapUICommand = class MapUICommand {
        ...
        constructor() {
          ...
          setInterval(() => {
            let list = this._proxy.getMyAllFacilitys();
        ...
        onCityFacilities(data) {
          ...
          if (data.code == 0) {
            ...
            let addition = this._proxy.updateMyCityAdditions(cityData.cityId);
        ...
        onCityUpFacility(data) {
          ...
          if (data.code == 0) {
            let facilityData = this._proxy.updateMyFacility(data.msg.cityId, data.msg.facility);
            ...
            let addition = this._proxy.updateMyCityAdditions(data.msg.cityId);
